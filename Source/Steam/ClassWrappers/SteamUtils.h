...
class SteamUtils007 : public ISteamUtils007
{
public:
	uint32 GetSecondsSinceAppActive();
	uint32 GetSecondsSinceComputerActive();
	...
	bool ShowGamepadTextInput(EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eInputLineMode, const char *szText, uint32 uMaxLength, const char * pUnk);
	uint32 GetEnteredGamepadTextLength();
	bool GetEnteredGamepadTextInput(char *pchValue, uint32 cchValueMax);
