...
{
	RedactedFriends::SetPersonaState(ePersonaState);
}
...
{
	return RedactedFriends::AddFriend(steamIDFriend);
}
...
{
	return RedactedFriends::RemoveFriend(steamIDFriend);
}
...
{
	return RedactedFriends::AddFriendByName(pchEmailOrAccountName);
}
...
{
	return RedactedFriends::HasFriend(steamIDFriend, eFriendFlags);
}
...
{
	return RedactedFriends::GetClanChatMessage(groupID, iChatID, pvData, cubData, peChatEntryType, pSteamIDChatter);
}
bool SteamFriends010::IsClanChatAdmin(CSteamID groupID, CSteamID userID) 
{
	return RedactedFriends::IsClanChatAdmin(groupID, userID);
}
bool SteamFriends010::IsClanChatWindowOpenInSteam(CSteamID groupID) 
{
	return RedactedFriends::IsClanChatWindowOpenInSteam(groupID);
}
bool SteamFriends010::OpenClanChatWindowInSteam(CSteamID groupID) 
{
	return RedactedFriends::OpenClanChatWindowInSteam(groupID);
}
bool SteamFriends010::CloseClanChatWindowInSteam(CSteamID groupID) 
{
	return RedactedFriends::CloseClanChatWindowInSteam(groupID);
}
bool SteamFriends010::SetListenForFriendsMessages(bool bListen) 
{
	return RedactedFriends::SetListenForFriendsMessages(bListen);
}
bool SteamFriends010::ReplyToFriendMessage(CSteamID friendID, const char *cszMessage) 
{
	return RedactedFriends::ReplyToFriendMessage(friendID, cszMessage);
}
...
{
	return RedactedFriends::GetFriendMessage(friendID, iChatID, pvData, cubData, peChatEntryType);
}
#pragma endregion
...
{
	RedactedFriends::ActivateGameOverlayToStore(nAppID, eFlag);
}
