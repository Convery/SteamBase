...
{
    return RedactedRemoteStorage::FileWrite(filename, data, cubData);
}

uint32 SteamRemoteStorage001::GetFileSize( const char *filename )
{
    return RedactedRemoteStorage::GetFileSize(filename);
}

bool SteamRemoteStorage001::FileRead( const char *filename, void *buffer, int size )
{
    int32 len = RedactedRemoteStorage::FileRead(filename, buffer, size);
	if (len > 0){
		return true;
	}
	return false;
...
{
    return RedactedRemoteStorage::FileExists(filename);
}

OBSOLETE_FUNCTION bool SteamRemoteStorage001::FileDelete( const char *filename )
{
    return RedactedRemoteStorage::FileDelete(filename);
}

uint32 SteamRemoteStorage001::GetFileCount()
{
    return RedactedRemoteStorage::GetFileCount();
}

const char *SteamRemoteStorage001::GetFileNameAndSize( int index, int *size )
{
    return RedactedRemoteStorage::GetFileNameAndSize(index, size);
}

bool SteamRemoteStorage001::GetQuota( int *current, int *maximum )
{
    return RedactedRemoteStorage::GetQuota(maximum, current);
}
#pragma endregion
...
{
    return RedactedRemoteStorage::FileWrite(pchFile, pvData, cubData);
}
int32 SteamRemoteStorage002::GetFileSize( const char *pchFile )
{
    return RedactedRemoteStorage::GetFileSize(pchFile);
}
int32 SteamRemoteStorage002::FileRead( const char *pchFile, void *pvData, int32 cubDataToRead )
{
    return RedactedRemoteStorage::FileRead(pchFile, pvData, cubDataToRead);
}
bool SteamRemoteStorage002::FileExists( const char *pchFile )
{
    return RedactedRemoteStorage::FileExists(pchFile);
}
...
{
    return RedactedRemoteStorage::GetFileNameAndSize(iFile, pnFileSizeInBytes);
}

// quota management
bool SteamRemoteStorage002::GetQuota( int32 *pnTotalBytes, int32 *puAvailableBytes )
{
    return RedactedRemoteStorage::GetQuota(pnTotalBytes, puAvailableBytes);
}
#pragma endregion
...
{
    return RedactedRemoteStorage::FileForget(pchFile);
}
bool SteamRemoteStorage003::FileDelete( const char *pchFile )
{
    return RedactedRemoteStorage::FileDelete(pchFile);
}
SteamAPICall_t SteamRemoteStorage003::FileShare( const char *pchFile )
{
    return RedactedRemoteStorage::FileShare(pchFile);
}
...
{
    return RedactedRemoteStorage::FilePersisted(pchFile);
}
...
{
    return RedactedRemoteStorage::GetFileTimestamp(pchFile);
}
...
{
    return RedactedRemoteStorage::IsCloudEnabledForAccount();
}
bool SteamRemoteStorage003::IsCloudEnabledThisApp()
{
    return RedactedRemoteStorage::IsCloudEnabledForApp();
}
bool SteamRemoteStorage003::SetCloudEnabledThisApp( bool bEnable )
{
    RedactedRemoteStorage::SetCloudEnabledForApp(bEnable);
	return true;
}
...
{
    //return RedactedRemoteStorage::UGCDownload(hContent, 0);
    return NULL;
...
{
    return RedactedRemoteStorage::GetUGCDetails(hContent, pnAppID, ppchName, pnFileSizeInBytes, pSteamIDOwner);
}
int32 SteamRemoteStorage003::UGCRead( UGCHandle_t hContent, void *pvData, int32 cubDataToRead )
{
	return RedactedRemoteStorage::UGCRead(hContent, pvData, cubDataToRead, 0, EUGCReadAction::k_EUGCRead_ContinueReadingUntilFinished);
}

// user generated content iteration
int32 SteamRemoteStorage003::GetCachedUGCCount()
{
    return RedactedRemoteStorage::GetCachedUGCCount();
}
UGCHandle_t SteamRemoteStorage003::GetCachedUGCHandle( int32 iCachedContent )
{
    return RedactedRemoteStorage::GetCachedUGCHandle(iCachedContent);
}
#pragma endregion
...
{
    return RedactedRemoteStorage::SetSyncPlatforms(pchFile, eRemoteStoragePlatform);
}
...
{
    return RedactedRemoteStorage::GetSyncPlatforms(pchFile);
}
...
{
    return RedactedRemoteStorage::SetCloudEnabledForApp(bEnabled);
}
...
{
    //return RedactedRemoteStorage::PublishWorkshopFile(pchFile, pchPreviewFile, nConsumerAppId, pchTitle, pchDescription, eVisibility, pTags, 0);
	return NULL;
}
...
{
	//return RedactedRemoteStorage::PublishWorkshopFile(pchFile, pchPreviewFile, nConsumerAppId, pchTitle, pchDescription, 0, pTags, EWorkshopFileType);
	return NULL;
}
...
{
    return RedactedRemoteStorage::GetUGCDownloadProgress(hContent, puDownloadedBytes, puTotalBytes);
}
...
{
    return RedactedRemoteStorage::PublishWorkshopFile(pchFile, pchPreviewFile, nConsumerAppId, pchTitle, pchDescription, eVisibility, pTags, eWorkshopFileType);
}
JobID_t SteamRemoteStorage006::CreatePublishedFileUpdateRequest( PublishedFileId_t unPublishedFileId )
{
    return RedactedRemoteStorage::CreatePublishedFileUpdateRequest(unPublishedFileId);
}
bool SteamRemoteStorage006::UpdatePublishedFileFile( JobID_t hUpdateRequest, const char *pchFile )
{
    return RedactedRemoteStorage::UpdatePublishedFileFile(hUpdateRequest, pchFile);
}
bool SteamRemoteStorage006::UpdatePublishedFilePreviewFile( JobID_t hUpdateRequest, const char *pchPreviewFile )
{
    return RedactedRemoteStorage::UpdatePublishedFilePreviewFile(hUpdateRequest, pchPreviewFile);
}
bool SteamRemoteStorage006::UpdatePublishedFileTitle( JobID_t hUpdateRequest, const char *pchTitle )
{
    return RedactedRemoteStorage::UpdatePublishedFileTitle(hUpdateRequest, pchTitle);
}
bool SteamRemoteStorage006::UpdatePublishedFileDescription( JobID_t hUpdateRequest, const char *pchDescription )
{
    return RedactedRemoteStorage::UpdatePublishedFileDescription(hUpdateRequest, pchDescription);
}
...
{
    return RedactedRemoteStorage::UpdatePublishedFileVisibility(hUpdateRequest, eVisibility);
}
bool SteamRemoteStorage006::UpdatePublishedFileTags( JobID_t hUpdateRequest, SteamParamStringArray_t *pTags )
{
    return RedactedRemoteStorage::UpdatePublishedFileTags(hUpdateRequest, pTags);
}
SteamAPICall_t SteamRemoteStorage006::CommitPublishedFileUpdate( JobID_t hUpdateRequest )
{
    return RedactedRemoteStorage::CommitPublishedFileUpdate(hUpdateRequest);
}
...
{
    return RedactedRemoteStorage::EnumerateUserPublishedFiles(uStartIndex);
}
...
{
    return RedactedRemoteStorage::EnumerateUserSubscribedFiles(uStartIndex);
}
...
{
    return RedactedRemoteStorage::UpdatePublishedFileSetChangeDescription(hUpdateRequest, cszDescription);
}
SteamAPICall_t SteamRemoteStorage006::GetPublishedItemVoteDetails( PublishedFileId_t unPublishedFileId )
{
    return RedactedRemoteStorage::GetPublishedItemVoteDetails(unPublishedFileId);
}
SteamAPICall_t SteamRemoteStorage006::UpdateUserPublishedItemVote( PublishedFileId_t unPublishedFileId, bool bVoteUp )
{
    return RedactedRemoteStorage::UpdateUserPublishedItemVote(unPublishedFileId, bVoteUp);
}
SteamAPICall_t SteamRemoteStorage006::GetUserPublishedItemVoteDetails( PublishedFileId_t unPublishedFileId )
{
    return RedactedRemoteStorage::GetUserPublishedItemVoteDetails(unPublishedFileId);
}
...
{
    return RedactedRemoteStorage::EnumerateUserSharedWorkshopFiles(nAppId, creatorSteamID, uStartIndex, pRequiredTags, pExcludedTags);
}
...
{
	return RedactedRemoteStorage::PublishVideo(EWorkshopVideoProvider::k_EWorkshopVideoProviderNone, "", "", cszFileName, nConsumerAppId, cszTitle, cszDescription, eVisibility, pTags);
}
...
{
    return RedactedRemoteStorage::SetUserPublishedFileAction(unPublishedFileId, eAction);
}
SteamAPICall_t SteamRemoteStorage006::EnumeratePublishedFilesByUserAction( EWorkshopFileAction eAction, uint32 uStartIndex )
{
    return RedactedRemoteStorage::EnumeratePublishedFilesByUserAction(eAction, uStartIndex);
}
...
{
    return RedactedRemoteStorage::EnumeratePublishedWorkshopFiles(eType, uStartIndex, cDays, cCount, pTags, pUserTags);
}
#pragma endregion
...
{
    return RedactedRemoteStorage::PublishVideo(eVideoProvider, cszVideoAccountName, cszVideoIdentifier, cszFileName, nConsumerAppId, cszTitle, cszDescription, eVisibility, pTags);
}
...
{
    return RedactedRemoteStorage::FileWriteStreamOpen(pchFile);
}
EResult SteamRemoteStorage008::FileWriteStreamWriteChunk( GID_t hStream, const void *pvData, int32 cubData )
{
    return RedactedRemoteStorage::FileWriteStreamWriteChunk(hStream, pvData, cubData);
}
EResult SteamRemoteStorage008::FileWriteStreamClose( GID_t hStream )
{
    return RedactedRemoteStorage::FileWriteStreamClose(hStream);
}
EResult SteamRemoteStorage008::FileWriteStreamCancel( GID_t hStream )
{
    return RedactedRemoteStorage::FileWriteStreamCancel(hStream);
}
...
{
	return RedactedRemoteStorage::UGCRead(hContent, pvData, cubDataToRead, uOffset, EUGCReadAction::k_EUGCRead_ContinueReadingUntilFinished);
}
...
{
    return RedactedRemoteStorage::UGCDownload(hContent, uUnk);
} // Returns a RemoteStorageDownloadUGCResult_t callback
...
{
    return RedactedRemoteStorage::UGCDownloadToLocation(hContent, cszLocation, uUnk);
}
#pragma endregion
...
{
    return RedactedRemoteStorage::GetPublishedFileDetails(unPublishedFileId, unMaxSecondsOld);
}
...
{
    return RedactedRemoteStorage::UGCRead(hContent, pvData, cubDataToRead, uOffset, eAction);
}
