...
{
	return RedactedMatchmaking::GetFavoriteGameCount();
}
...
{
	return RedactedMatchmaking::GetFavoriteGame(iGame, pnAppID, pnIP, pnConnPort, 0, punFlags, pRTime32LastPlayedOnServer);
}
...
{
	return RedactedMatchmaking::AddFavoriteGame(nAppID, nIP, nConnPort, 0, unFlags, rTime32LastPlayedOnServer);
}

bool SteamMatchmaking001::RemoveFavoriteGame(uint32 nAppID, uint32 nIP, uint16 nConnPort, uint32 unFlags)
{
	return RedactedMatchmaking::RemoveFavoriteGame(nAppID, nIP, nConnPort, 0, unFlags);
}
...
{
	return RedactedMatchmaking::GetFavoriteGame(iGame, pnAppID, pnIP, pnConnPort, pnQueryPort, punFlags, pRTime32LastPlayedOnServer);
}
...
{
	return RedactedMatchmaking::AddFavoriteGame(nAppID, nIP, nConnPort, nQueryPort, unFlags, rTime32LastPlayedOnServer);
}

bool SteamMatchmaking001::RemoveFavoriteGame2(uint32 nAppID, uint32 nIP, uint16 nConnPort, uint16 nQueryPort, uint32 unFlags)
{
	return RedactedMatchmaking::RemoveFavoriteGame(nAppID, nIP, nConnPort, nQueryPort, unFlags);
}

void SteamMatchmaking001::RequestLobbyList(uint64 ulGameID, MatchMakingKeyValuePair_t *pFilters, uint32 nFilters)
{
	RedactedMatchmaking::RequestLobbyList(ulGameID, pFilters, nFilters);
}

CSteamID SteamMatchmaking001::GetLobbyByIndex(int iLobby)
{
	return RedactedMatchmaking::GetLobbyByIndex(iLobby);
}

void SteamMatchmaking001::CreateLobby(uint64 ulGameID, bool bPrivate)
{
	RedactedMatchmaking::CreateLobby(bPrivate ? ELobbyType::k_ELobbyTypePrivate : ELobbyType::k_ELobbyTypePublic, 4/* is hardcoding this a good idea?*/);
}
...
{
	return RedactedMatchmaking::InviteUserToLobby(steamIDLobby, steamIDInvitee);
}

int SteamMatchmaking001::GetNumLobbyMembers(CSteamID steamIDLobby)
{
	return RedactedMatchmaking::GetNumLobbyMembers(steamIDLobby);
}

CSteamID SteamMatchmaking001::GetLobbyMemberByIndex(CSteamID steamIDLobby, int iMember)
{
	return RedactedMatchmaking::GetLobbyMemberByIndex(steamIDLobby, iMember);
}

const char* SteamMatchmaking001::GetLobbyData(CSteamID SteamIDLobby, const char *pchKey)
{
	return RedactedMatchmaking::GetLobbyData(SteamIDLobby, pchKey);
}
...
{
	return RedactedMatchmaking::GetLobbyMemberData(steamIDLobby, steamIDUser, pchKey);
}
...
{
	RedactedMatchmaking::SetLobbyOwner(steamIDLobby, steamIDNewAdmin);
}

bool SteamMatchmaking001::SendLobbyChatMsg(CSteamID steamIDLobby, const void *pvMsgBody, int cubMsgBody)
{
	return RedactedMatchmaking::SendLobbyChatMsg(steamIDLobby, pvMsgBody, cubMsgBody);
}
...
{
	return RedactedMatchmaking::GetLobbyChatEntry(steamIDLobby, iChatID, pSteamIDUser, pvData, cubData, peChatEntryType);
}

bool SteamMatchmaking001::RequestLobbyData(CSteamID steamIDLobby)
{
	return RedactedMatchmaking::RequestLobbyData(steamIDLobby);
}
#pragma endregion
...
{
	RedactedMatchmaking::RequestLobbyList();
}
...
{
	RedactedMatchmaking::CreateLobby(bPrivate ? ELobbyType::k_ELobbyTypePrivate : ELobbyType::k_ELobbyTypePublic, 4);//assume something high enough? there is no SetLobbyMemberLimit
}
...
SteamAPICall_t SteamMatchmaking003::RequestLobbyList(){
	return RedactedMatchmaking::RequestLobbyList();
}
...
{
	RedactedMatchmaking::CreateLobby(bPrivate ? ELobbyType::k_ELobbyTypePrivate : ELobbyType::k_ELobbyTypePublic);
}
...
{
	return RedactedMatchmaking::GetLobbyGameServer(steamIDLobby, punGameServerIP, punGameServerPort, psteamIDGameServer);
}

bool SteamMatchmaking003::SetLobbyMemberLimit(CSteamID steamIDLobby, int cMaxMembers)
{
	return RedactedMatchmaking::SetLobbyMemberLimit(steamIDLobby, cMaxMembers);
}
int SteamMatchmaking003::GetLobbyMemberLimit(CSteamID steamIDLobby)
{
	return RedactedMatchmaking::GetLobbyMemberLimit(steamIDLobby);
}
...
{
	return RedactedMatchmaking::RequestFriendsLobbies();
}
#pragma endregion
...
{
	return RedactedMatchmaking::SetLobbyType(steamIDLobby, eLobbyType);
}

CSteamID SteamMatchmaking005::GetLobbyOwner(CSteamID steamIDLobby)
{
	return RedactedMatchmaking::GetLobbyOwner(steamIDLobby);
}
...
{
	return RedactedMatchmaking::GetLobbyDataCount(steamIDLobby);
}
...
{
	return RedactedMatchmaking::GetLobbyDataByIndex(steamIDLobby, iLobbyData, pchKey, cchKeyBufferSize, pchValue, cchValueBufferSize);
}

bool SteamMatchmaking007::DeleteLobbyData(CSteamID steamIDLobby, const char *pchKey)
{
	return RedactedMatchmaking::DeleteLobbyData(steamIDLobby, pchKey);
}
...
{
	return RedactedMatchmaking::SetLobbyJoinable(steamIDLobby, bLobbyJoinable);
}
...
{
	return RedactedMatchmaking::SetLobbyOwner(steamIDLobby, steamIDNewOwner);
}
...
{
	return RedactedMatchmaking::SetLinkedLobby(steamIDLobby, steamIDLobby2);
}
